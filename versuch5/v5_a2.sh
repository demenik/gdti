...
ghdl -a my_logical_unit.vhdl
ghdl -a my_logical_unit_tb.vhdl
ghdl -e my_logical_unit_tb
ghdl -r my_logical_unit_tb --vcd=my_logical_unit.vcd
gtkwave my_logical_unit.vcd
